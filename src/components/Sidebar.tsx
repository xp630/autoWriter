...
const NAV_GROUPS: { label: string; items: NavItem[] }[] = [
  {
    label: '概览',
    items: [
      { id: 'dashboard', label: '仪表盘', kbd: '⌘0',
        icon: <g strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="3" width="7" height="9" rx="1" /><rect x="14" y="3" width="7" height="5" rx="1" /><rect x="14" y="12" width="7" height="9" rx="1" /><rect x="3" y="16" width="7" height="5" rx="1" /></g> },
    ],
  },
  {
    label: '创作',
    items: [
      ...
      { id: 'quick-publish', label: '快速发布', kbd: '⌘3',
        icon: <g strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M13 2L3 14h9l-1 8 10-12h-9l1-8z" /><path d="M21 15l-5-5L5 21" /></g> },
      { id: 'strategies', label: '策略库',
        icon: <g strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><polygon points="12 2 2 7 12 12 22 7 12 2" /><polyline points="2 17 12 22 22 17" /><polyline points="2 12 12 17 22 12" /></g> },
    ],
  },
  {
    label: '素材',
