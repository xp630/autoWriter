...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  // P0 Week 1: Season + Episode (Episode-centric 数据)
  listSeasons:   (params) => ipcRenderer.invoke('season:list', params),
  ...
  evidenceSave: (params) => ipcRenderer.invoke('evidence:save', params),
  evidenceDelete: (id) => ipcRenderer.invoke('evidence:delete', id),
  insightConfirm: (params) => ipcRenderer.invoke('insight:confirm', params),
  planPropose: (params) => ipcRenderer.invoke('plan:propose', params),
  planConfirm: (params) => ipcRenderer.invoke('plan:confirm', params),
  planList: (episodeId) => ipcRenderer.invoke('plan:list', episodeId),
  episodeMaterial: (episodeId) => ipcRenderer.invoke('episode:material', episodeId),
